...
time_map5 = {
    ...
    'Beach': {'Campus': 14, 'Whole_Food': 14, 'Beach': None, 'Cinema': None, 'Lighthouse': None, 'Ryan_Field': None, 'YWCA': None},
    'Cinema': {'Campus': None, 'Whole_Food': None, 'Beach': None, 'Cinema': None, 'Lighthouse': None, 'Ryan_Field': None, 'YWCA': 12},
...
class SearchTest(unittest.TestCase):
    ...
    def test4(self):
        ...
        self.assertEqual(path, ['Campus', 'Lighthouse',
                                'Ryan_Field', 'YWCA', 'Cinema'])
        self.assertEqual(expand.expand_count, 6)
